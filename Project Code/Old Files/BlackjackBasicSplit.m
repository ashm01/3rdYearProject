function BlackjackBasic(numDecks, numHands, numGames)
                            ...
                            switch dealer.Total
                                ...
                                case 7
                                    ...
                                    if (player.Hand(currentHand).Card(1).BJvalue == player.Hand(currentHand).Card(2).BJvalue && player.Hand(currentHand).Total ~= 20 && numCards == 2 ...
                                             && player.Hand(currentHand).Total ~= 10 ...
                                             && player.Hand(currentHand).Total ~= 8  ...
                                             && player.Hand(currentHand).Total ~= 12)
                                        splitHand();
                                ...
                                case 8
                                    ...
                                    %Tens(10 J K Q)
                                    if (player.Hand(currentHand).Card(1).BJvalue == player.Hand(currentHand).Card(2).BJvalue && player.Hand(currentHand).Total == 16 && numCards == 2 ...
                                             || player.Hand(currentHand).Card(1).BJvalue == player.Hand(currentHand).Card(2).BJvalue && player.Hand(currentHand).Total == 18 && numCards == 2 ...
                                             || player.Hand(currentHand).Card(1).BJvalue == player.Hand(currentHand).Card(2).BJvalue && player.Hand(currentHand).Total == 22 && numCards == 2)
                                        splitHand();
                                    %DOUBLE DOWN - 10, 11 or a pair of 5s
                                ...
                                case 10
                                    %SPLIT - only 8, 9 and aces
                                    %Tens(10 J K Q)
                                    if (player.Hand(currentHand).Card(1).BJvalue == player.Hand(currentHand).Card(2).BJvalue && player.Hand(currentHand).Total == 22 && numCards == 2)
                                            splitHand();
...
function printHands
    ...
    if(handNumber == 1)
        profitOrloss = player.Bankroll(handNumber);
            
    else
        profitOrloss = player.Bankroll(handNumber)- player.Bankroll(handNumber-1);
        
        end
    
    %if(profitOrloss > 0 && player.Hand(1).Total < dealer.Total && dealer.Total <22)
    if(player.Hand(1).Ace >0)
    %if(profitOrloss > 4)
        ...
        if(handNumber == 1)
            disp(strcat('Profit/loss = ',num2str(player.Bankroll(handNumber))));
        else
