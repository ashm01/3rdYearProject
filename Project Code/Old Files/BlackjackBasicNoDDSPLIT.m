function BlackjackBasicNoDDSPLIT(numDecks, numHands, numGames)
...
%                                     else
                                ...
                                case 10
                                    %SPLIT - only 8, 9 and aces
                                    %Tens(10 J K Q)
%                                     if (player.Hand(currentHand).Card(1).BJvalue == player.Hand(currentHand).Card(2).BJvalue && player.Hand(currentHand).Total == 22)
%                                             splitHand();
% 
%                                     %DOUBLE DOWN - 11
%                                     %NO DOUBLE DOWN
...
function printHands
    ...
    if(profitOrloss > 0 && player.Hand(1).Total > 21)
        handNumber
