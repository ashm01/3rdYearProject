        ...
        while endGame == 0
            ...
            if(deckPosition > 39*numDecks)
                       ...
                       numCards = length(player.Hand(currentHand).Card);
                        if(player.Hand(currentHand).Stand == 0) 
                            switch dealer.Total
                                %dealer showing a 2
                                case 2
                                    if (player.Hand(currentHand).Total > 9 && player.Hand(currentHand).Total < 12 && numCards == 2 ||...
                                ...
                                %dealer showing a 3    
                                case 3
                                    if (player.Hand(currentHand).Total > 8 && player.Hand(currentHand).Total < 12 && numCards == 2 ||...
                                            player.Hand(currentHand).Card(1).Rank == 5 && player.Hand(currentHand).Card(2).Rank == 5 && numCards == 2 || ...
                                ...
                                %dealer showing a 4    
                                case 4
                                    if (player.Hand(currentHand).Total > 8 && player.Hand(currentHand).Total < 12 && numCards == 2 && numCards == 2 ||...
                                            player.Hand(currentHand).Card(1).Rank == 5 && player.Hand(currentHand).Card(2).Rank == 5 && numCards == 2 || ...
                                ...
                                case 10
                                    if(player.Hand(currentHand).Total < 17 ||...
                                            player.Hand(currentHand).Ace > 0 && player.Hand(currentHand).Total > 16 && player.Hand(currentHand).Total < 19 )
                ...
                if(player.bustHands ~= player.splitCounter)
                    ...
                    for handIndex = 1:player.splitCounter
                        %determing the winner of the hand
                        if(player.Hand(handIndex).bust == 1)
                            bankroll = bankroll - player.Hand(handIndex).betAmount;
                            
                        elseif(dealer.Total > 21)
                            bankroll = bankroll + player.Hand(handIndex).betAmount;
                            
                        elseif (dealer.Total < player.Hand(handIndex).Total)
                            bankroll = bankroll + player.Hand(handIndex).betAmount;
                    ...
                    for i = 1:player.splitCounter
                        bankroll = bankroll - player.Hand(i).betAmount;
                        player.Bankroll(handNumber) = bankroll;
                    end
                end
                end
