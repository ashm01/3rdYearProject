function BlackjackBasicWithDouble(numDecks, numHands, numGames)
...
%                  clc;
    ...
    plot(results)
    title('Basic Strategy with double down, no splitting - 10000, 100 Game Sessions')
...
function printHands
    ...
    if(handNumber == 1)
        profitOrloss = player.Bankroll(handNumber)-100;
