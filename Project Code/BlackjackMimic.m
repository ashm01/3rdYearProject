function BlackjackMimic(numDecks, numHands, numGames)
            ...
            if(deckPosition > 39*numDecks)
                ...
                if(player.Total == 21)
                    ...
                    while endHand == 0;
                        ...
                        %This will happen as soon as the players hand value is
                        %above 17
                        if(player.Total > 16)
                            dealer.Hand(2) = deck(deckPosition);
                            deckPosition = deckPosition +1;
                            ...
                            while dealer.Total < 17
                                ...
                                deckPosition = deckPosition +1;
                                if(strcmp(dealer.Hand(end).FaceValue, 'A'))
                                   dealer.Ace = dealer.Ace +1;
                                end
                            ...
                            if(dealer.Total > 21 && player.Total < 22 || dealer.Total < player.Total && player.Total < 22)
                                bankroll = bankroll + 1;
                                player.Bankroll(handNumber) = bankroll;
                                endHand = 1;
    ...
    plot(results)
    title('Blackjack with Mimic the Dealer Strategy - 10000, 100 Game Sessions')
