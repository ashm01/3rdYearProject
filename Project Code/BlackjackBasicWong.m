function BlackjackBasicWong(numDecks, numHands, numGames)
...
%                  clc;
    ...
    plot(results)
    title('Basic Strategy with Wong Halves Card Counting - 10000, 100 Game Sessions')
...
function updateCount(card)
    ...
    %ZEN COUNT
    player.runningCount = player.runningCount + card.WongValue;
